const LANGUAGE_STYLES = {
  ...
  Odia: {
    ...
    instruction: 'Reply in simple Odia. Use Odia script for the main reply. Do not use Hinglish filler such as "Theek hai" or "jankari rakh li" unless the learner used it first. Keep the tone human and counselor-like.',
  },
  Bengali: {
    name: 'Bengali',
    script: 'Bengali',
    stt_language_code: 'bn-IN',
    instruction: 'Reply in simple Bengali using Bengali script for the main reply. Do not use Hinglish filler such as "Theek hai" or "jankari rakh li" unless the learner used it first. Use short spoken Bengali.',
  },
  Marathi: {
    name: 'Marathi',
    script: 'Devanagari',
    stt_language_code: 'mr-IN',
    instruction: 'Reply in simple Marathi using Devanagari for the main reply. Do not use Hinglish filler such as "Theek hai" or "jankari rakh li" unless the learner used it first. Use Meera as a female counselor or neutral wording.',
  },
  Tamil: {
    name: 'Tamil',
    script: 'Tamil',
    stt_language_code: 'ta-IN',
    instruction: 'Reply in simple Tamil using Tamil script for the main reply. Do not use Hinglish filler such as "Theek hai" or "jankari rakh li" unless the learner used it first. Use short spoken Tamil.',
  },
  Telugu: {
    name: 'Telugu',
    script: 'Telugu',
